      ...
      <div className="relative flex flex-col flex-1 min-h-0">
        ...
        <div className="px-6 py-6 border-b border-brand-border/60">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-display font-bold text-brand-white text-sm leading-tight">Mr. H Digital</p>
        ...
        <div className="px-3 py-4 border-t border-brand-border/60 space-y-1">
          <button
            disabled
            className="flex items-center gap-3 px-3 py-3 rounded-lg text-sm text-brand-muted w-full cursor-not-allowed opacity-50"
          >
            <Settings size={18} />
            Settings
          </button>

          {/* User info + logout — always visible logout on mobile */}
          <div className="mt-2">
            <div className="flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-white/5 group transition-colors">
              <div className="min-w-0">
                <p className="text-brand-text text-xs font-medium truncate">{user?.email ?? 'Lee Hildebrandt'}</p>
